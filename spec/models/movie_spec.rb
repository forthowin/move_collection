...
describe Movie do
  ...
  it { should validate_prsence_of :format }
  it { should validate_prsence_of :length }
  it { should validate_prsence_of :release_year }
  it { should validate_prsence_of :rating }
